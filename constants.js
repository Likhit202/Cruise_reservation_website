...
export const cruiseConstants ={
    GET_ALL_CRUISES_REQUEST: 'GET_ALL_CRUISES_REQUEST',
    GET_ALL_CRUISES_SUCCESS: 'GET_ALL_CRUISES_SUCCESS',
    GET_ALL_CRUISES_FAILURE: 'GET_ALL_CRUISES_FAILURE',
}
